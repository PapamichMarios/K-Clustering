...
std::vector<int> hypercube(HyperCube<std::vector<double>> * hyper_cubeptr, std::vector<std::vector<double>> data, std::vector<std::vector<double>> centroids, int probes, int M, int data_size);
